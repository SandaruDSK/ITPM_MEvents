...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	<head>
	    ...
	    <meta charset="utf-8">
	    <meta name="keywords" content="72%, 100%, 87%, Empire State Building">
	    <meta name="description" content="">
	    <meta name="page_type" content="np-template-header-footer-from-plugin">

        <title>MEvents PVT LTD</title>
        
        <link rel="stylesheet" href="css/About/nicepage.css" media="screen">
		<link rel="stylesheet" href="css/About/About.css" media="screen">
	    <script class="u-script" type="text/javascript" src="js/About/jquery.js" defer=""></script>
	    <script class="u-script" type="text/javascript" src="js/About/nicepage.js" defer=""></script>
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
								...
								<li>
									...
									<ul>	
										<li>
											<a href="customerinsert.jsp">Add Customer</a>
										</li>
										<li>
											<a href="search.jsp">Customer Details</a>
										</li>
										<li>
											<a href="updatecustomer.jsp">Edit Customer Details</a>
										</li>
										<li>
...
<h2>Register</h2>
<form action="insert" method="post" onsubmit="required()">
	<div class="container">
		...
		<label for="phone">Phone Number</label> <input type="text" name="phone" required><br>
		<label for="un">User Name</label> <input type="text" name="uid" required><br>
		<label for="pass">Password</label> <input type="password" name="psw" required><br>
