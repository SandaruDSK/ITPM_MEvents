                  ...
                  <div class="content_wrap">
                     <div class="columns_wrap">
                        ...
                        <div class="column-3">
						 ...
						 <div class="column-3">
						 <h5>Contact us</h5>
                                 <span class="accent1h margin_right_tiny icon-location"></span> No,1/1 Colombo, Sri lanka
                                 <br>
                                 <span class="accent1h margin_right_tiny icon-tablet"></span> +94 111 234 567
                                 <br>
                                 <span class="accent1h margin_right_tiny icon-mail"></span> info@mevents.lk
                              </div>
                        <div class="column-3">
                           <h5>follow us</h5>
