                  ...
                  <div class="top_panel_wrap_inner top_panel_inner_style_1 top_panel_position_over">
                     <div class="content_wrap clearfix">
                        <div class="top_panel_logo">
                           <div class="logo">
                              <a href="/"><img src="images/logo.png" style="max-width:150px"class="img-responsive" class="logo_main" alt=""></a>
                           </div>
                        </div>
						<div class="top_panel_contacts">
                           <div class="top_panel_contacts_left">
                              <div class="contact_phone">No,1/1 Colombo, Sri lanka</div>
                              <div class="contact_email">info@mevents.lk</div>
                           </div>
                           <div class="top_panel_contacts_right">call us : <a href="tel:0111234567">+94 111 234 567</a></div>
                           <div class="cL"></div>
                        </div>
